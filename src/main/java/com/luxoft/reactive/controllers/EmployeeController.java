...
import com.luxoft.reactive.services.EmployeeService;
...
public class EmployeeController {
    ...
    public Mono<ResponseEntity<EmployeeDto>> getEmployeeById(@PathVariable(name = "id") String id) {
    ...
    public Flux<EmployeeDto> getAllEmployeesByDepartmentId(@PathVariable(name = "id") String id) {
    ...
    public Mono<Void> removeEmployeeById(@PathVariable(name = "id") String id) {
