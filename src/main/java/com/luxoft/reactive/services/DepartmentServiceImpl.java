...
import com.luxoft.reactive.repository.DepartmentRepository;
...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Transactional
    public Mono<DepartmentDto> getDepartmentById(String id) {
    ...
    public Mono<Department> saveDepartment(Department department) {
        Predicate<String> idIsNul = Objects::isNull;
    ...
    @Transactional
    public Mono<Void> removeDepartmentById(String id) {
